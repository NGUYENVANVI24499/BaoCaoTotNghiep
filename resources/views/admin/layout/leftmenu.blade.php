                    ...
                    <ul class="metismenu" id="menu1">
                        <li>
                            <a class="has-arrow" href="javascript:void(0)">
                               ...
                               <span class="mini-click-non">Trang chủ  
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Cây thư mục" href="quantri/caythumuc"><span class="mini-sub-pro">Cây thư mục</span></a></li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                              <!--   <li><a title="Danh mục sản phẩm" href="quantri/quantrivien/danhsach"><span class="mini-sub-pro">Quản trị viên</span></a></li> -->
                                ...
                                <li><a title="Loại sản phẩm" href="quantri/sells/danhsach"><span class="mini-sub-pro">Người dùng bán hàng</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="javascript:void(0)" aria-expanded="false">
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li> 
                                    <a title="Sản phẩm" href="quantri/sanpham/danhsach"><span class="mini-sub-pro">Sản phẩm</span></a></li>
                        ...
                        <li>
                            <a class="has-arrow" href="javascript:void(0)" aria-expanded="false">
                                <span class="icon-wrap"><i class="fa fa-user-circle"></i></span> 
                                <span class="mini-click-non">Chats </span>
                            </a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="chat" href="chats"><span class="mini-sub-pro">chat</span></a></li>
