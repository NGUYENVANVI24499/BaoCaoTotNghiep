				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6">
						<div class="footer-logo">
							<img src="uploads/images/logo/x-gaming-logo2-.jpg" alt="Footer Logo">
							<p class="info">
								C2C shop, Cung cấp sản phẩm chất lượng tốt nhất...
							</p>
						</div>
						<ul class="des">
							<li>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="copyright text-center pt-25">
						<span><a href="https://www.facebook.com/rubiti99" target="_blank">{{$all_share_sp_cai_dat_trang_chu->ban_quyen}}</a></span>
					</div>
