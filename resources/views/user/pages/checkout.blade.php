	...
	<div class="container">  
		...
		<div class="row"> 
			<div class="col-lg-6 col-12">
				<form id="submitform" action="thanh-toan.html" method="POST">
					@csrf
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="checkout-form-list">
									...
									<input value="{{Auth::guard('web')->user()->diachi}}" name="dia_chi" placeholder="Nhập địa chỉ nhận hàng" type="text" required>
								</div>
							</div>
							<div class="col-md-12">
								<div class="checkout-form-list">
									<label>Họ và tên <span class="required">*</span></label>
									<input value="{{Auth::guard('web')->user()->display_name}}"  name="ho_ten" placeholder="Nhập họ và tên người nhận hàng" type="text" required>
								</div>
							</div>   
							<div class="col-md-6">
								<div class="checkout-form-list">
									<label>Email <span class="required">*</span></label>
									<input value="{{Auth::guard('web')->user()->email}}" name="email" placeholder="Nhập vào email của bạn" type="email"required>
								</div>
							</div>
							<div class="col-md-6">
								<div class="checkout-form-list">
									<label>Số điện thoại  <span class="required">*</span></label>
									<input value="{{Auth::guard('web')->user()->sdt}}" name="dien_thoai" placeholder="Nhập vào số điện thoại người nhận hàng" type="text" required onKeyPress="return khongNhapKyTu(event);">
								</div>
							</div>
							<div class="col-md-12">
								<div class="checkout-form-list">
							...
							<div class="col-md-12">
									...
									<?php
										$total_after = $gio_hang->tong_gia;
										$vnd_to_usb = $total_after/23083;

									 ?>
									 
									<div id="paypal-button"></div>
									<input type="hidden" id="vnd_to_usb" value="{{round($vnd_to_usb,2)}}" name="">
								</div>
							<div class="col-md-12">
								<div class="checkout-form-list">
