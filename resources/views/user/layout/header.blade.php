					...
					<div class="header-top-right">
						<ul class="ht-menu">
							...
							<li>
								...
								<a  class="currency-selector-wrapper" href="{{URL::to('dangkybanhang')}}"> đăng ký bán hàng</a>
	...
	<div class="header-middle pl-sm-0 pr-sm-0 pl-xs-0 pr-xs-0">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3">
					<div class="logo pb-sm-10 pb-xs-10">
						<a href="trang-chu.html">
							<img style="height: 60px;width: 50px;" src="uploads/images/logo/<?php echo $all_share_sp_cai_dat_trang_chu->logo; ?>" alt="logo-dai-dien">
						</a>
					</div>
				</div>
