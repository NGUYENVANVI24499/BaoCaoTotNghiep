...
{ 
    ...
    public function getSanPham($ten_khong_dau, $id){
      $san_phams= san_phams::find($id);
      
     $idadmin= $san_phams->id_admin;
      $admins = admins::find($idadmin);

      $id_adminshop = $admins->id;
       ...
       if($san_pham != null){
          ...
          ->orderBy('id','DESC')
          ->get();
          return view('user.pages.product')->with(compact('san_pham','hinh_anh_san_pham','san_pham_cung_loai','phan_hoi_san_pham','id_adminshop'));
        }
